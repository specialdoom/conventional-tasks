<script>
  /** @type {string} Specify the name of the checkbox element. */
  export let name;

  /** @type {boolean} Whether the checkbox is checked or not. */
  export let checked = false;

  /** @type {boolean} Whether the checkbox is disabled or not. */
  export let disabled = false;

  /** @type {boolean} Whether the checkbox has an error state or not. */
  export let error = false;

  /** @type {string} The label of the checkbox. */
  export let label = "";

  /** @type {number} The number of the rendered checkbox. */
  export let count = 0;
</script>
...
>
  ...
  <button
    ...
    class:disabled
    class:error
    class="cui--checkbox cui--{count % 5}"
  >
    <svg
      width="24"
      height="24"
